...
const publishSchedulesButton = await page.$('a[href="/PublishSchedules"]');
await publishSchedulesButton.click();

await page.waitForFunction('window.location.href.includes("/PublishSchedules")');
await page.waitForSelector('#publish-schedules', { visible: true });
