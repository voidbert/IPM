...
const completeScheduleButton = await page.$('a[href="/CompleteSchedule"]');
await completeScheduleButton.click();

await page.waitForFunction('window.location.href.includes("/CompleteSchedule")');
await page.waitForSelector('#complete-schedule-tip', { visible: true });
