...
const requestsHistoryButton = await page.$('a[href="/RequestsHistory"]');
await requestsHistoryButton.click();

await page.waitForFunction('window.location.href.includes("/RequestsHistory")');
await page.waitForSelector('#requests-history-main', { visible: true });
