...
const notificationsButton = await page.$('button.navbar-hoverable-icon[title="Notificações"]');
await notificationsButton.click();

await page.waitForFunction('window.location.href.includes("/Notifications")');
await page.waitForSelector('#notifications-title', { visible: true });
