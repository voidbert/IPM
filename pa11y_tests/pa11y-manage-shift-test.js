...
await page.goto('http://localhost:5173/ManageShifts/64');

await page.waitForFunction('window.location.href.includes("/ManageShifts/64")');
await page.waitForSelector('#manage-shift-page-container', { visible: true });
